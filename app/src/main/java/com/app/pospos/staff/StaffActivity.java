...
import com.app.pospos.adapter.StaffAdapter;
...
public class StaffActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(StaffActivity.this, SettingActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(StaffActivity.this, AddstaffActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mSwipeRefreshLayout.setOnRefreshListener(() -> {
            if (utils.isNetworkAvailable(StaffActivity.this)) {
                getStaff("");
            } else {
                Toasty.error(StaffActivity.this, R.string.no_network_connection, Toast.LENGTH_SHORT).show();
            }
    ...
    public void getStaff(String searchText) {
        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<List<Staff>> call;
        call = apiInterface.get_staff(searchText);
        ...
        call.enqueue(new Callback<List<Staff>>() {
            ...
            public void onResponse(@NonNull Call<List<Staff>> call, @NonNull Response<List<Staff>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (customerList.isEmpty()) {
                        ...
                        StaffAdapter staffAdapter = new StaffAdapter(StaffActivity.this, customerList);
            ...
            public void onFailure(@NonNull Call<List<Staff>> call, @NonNull Throwable t) {
                ...
                Toast.makeText(StaffActivity.this, R.string.something_went_wrong, Toast.LENGTH_SHORT).show();
