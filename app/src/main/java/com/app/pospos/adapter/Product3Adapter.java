...
public class Product3Adapter extends RecyclerView.Adapter<Product3Adapter.MyViewHolder> {
    ...
    public Product3Adapter(Context context, List<Product> customerData) {
    ...
    @NonNull
    @Override
    public Product3Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Product3Adapter.MyViewHolder holder, int position) {
