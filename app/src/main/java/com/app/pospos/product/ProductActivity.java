...
import com.app.pospos.adapter.Product_tAdapter;
...
public class ProductActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ສີນຄ້າ");
        ...
        img_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ProductActivity.this, Addproduct_Activity.class);
                startActivity(i);
                finish();
            }
        });
            ...
            public void onResponse(@NonNull Call<List<Product>> call, @NonNull Response<List<Product>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (customerList.isEmpty()) {
                        ...
                        Product_tAdapter product_tAdapter = new Product_tAdapter(ProductActivity.this, customerList);
                        recyclerView.setAdapter(product_tAdapter);
